...
cobertura: [
  ...
  function atualizarListaProdutos() {
      var listaProdutosElement = document.getElementById("listaProdutosUl");
      var corpoTabelaProdutos = document.getElementById("corpoTabelaProdutos");

      // Limpar a lista antes de atualizar
      listaProdutosElement.innerHTML = "";
      corpoTabelaProdutos.innerHTML = "";

      // Adicionar cada local e seus produtos à lista e à tabela
      produtosDescartados.forEach(function (local) {
          ...
          var rowTabelaProdutos = document.createElement("tr");
          var cellLocal = document.createElement("td");
          cellLocal.textContent = local.local;
          rowTabelaProdutos.appendChild(cellLocal);
          ...
          local.produtos.forEach(function (produto) {
              ...
              var cellProduto = document.createElement("td");
              ...
              var rowTabelaProduto = document.createElement("tr");
              rowTabelaProduto.appendChild(cellLocal.cloneNode(true));
              rowTabelaProduto.appendChild(cellProduto);
              rowTabelaProduto.appendChild(cellQuantidade);
              corpoTabelaProdutos.appendChild(rowTabelaProduto);
          });
      });
  }
  function alternarVisualizacao() {
var listaProdutosElement = document.getElementById("listaProdutos");
var tabelaProdutosElement = document.getElementById("tabelaProdutos");

if (listaProdutosElement.style.display !== "none") {
  // Se a lista está visível, esconde a lista e exibe a tabela
  listaProdutosElement.style.display = "none";
  tabelaProdutosElement.style.display = "block";
} else {
  // Se a tabela está visível, esconde a tabela e exibe a lista
  listaProdutosElement.style.display = "block";
  tabelaProdutosElement.style.display = "none";
}
}
